    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    if (!_roleManage.RoleExistsAsync(model.RoleName).GetAwaiter().GetResult())
                    {
                        ...
                        await _roleManage.CreateAsync(userRole);
                    }

                    await _userManage.AddToRoleAsync(user, model.RoleName);

                    await _userManage.AddClaimsAsync(user, new Claim[]{
                    ...
                    {
                        var checkuser = await _userManage.FindByNameAsync(model.Username);
